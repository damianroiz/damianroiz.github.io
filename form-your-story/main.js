// Here I take the values from the submitted form

const words = new URLSearchParams(window.location.search);

// clean up and throw names in capitals
...
// Matching variables with values from the story
...
// Populate the story.html page with strings 
